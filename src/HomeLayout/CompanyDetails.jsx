...
import { cardAnimation, modalAnimation } from '../Components/animation';
        ...
        <div className='mx-auto text-center p-20 '>
                ...
                <div className='flex flex-col gap-6 bg-gray-200 p-5 '>
                    {
                        jobs.map(job => (
                            <motion.div
                                ...
                                className='p-5 bg-gradient-to-b from-blue-50 via-white to-blue-100 rounded-2xl shadow-xl font-bold text-lg flex flex-col items-center justify-center'
                            >
            ...
            <AnimatePresence>
                {modalJob && (
                    ...
                    >
                        <motion.div
                            className="bg-gray-200 p-6 rounded-xl w-[400px] shadow-xl border"
